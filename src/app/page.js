...
function AnnouncementBar() {
  return (
    <div className="relative z-50 bg-[#06070a] border-b border-white/5">
      <div className="mx-auto max-w-[1360px] px-5 md:px-12 h-9 flex items-center justify-between gap-4 mono text-[10.5px] tracking-[0.18em] uppercase text-paper/60">
...
function Nav() {
  return (
    <header className="sticky top-0 z-40 backdrop-blur-md bg-[#06070a]/72 border-b border-white/5">
      <div className="mx-auto max-w-[1360px] px-5 md:px-12 h-[68px] md:h-[80px] flex items-center justify-between gap-6">
        ...
        >
          <span className="grid place-items-center h-7 w-7 rounded-md bg-brand/15 border border-brand/30">
            <span className="mono text-[11px] tracking-[0.04em] font-semibold text-brand">
              AE
            </span>
          </span>
          <span className="font-medium tracking-[-0.02em] text-[18px]">
...
function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative overflow-hidden dark-stage text-paper min-h-screen flex flex-col"
    >
      <div className="relative flex-1 flex flex-col">
        {/* Background hero image with mask */}
        <img
          src="/hero-academia.jpg"
          alt="Bibliothèque institutionnelle française au crépuscule, ligne lumineuse verte AcademIA"
          aria-hidden
          draggable={false}
          className="pointer-events-none absolute inset-x-0 bottom-0 w-full h-[74%] md:h-[70%] object-cover object-[center_bottom] opacity-[0.92] select-none z-0 [mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.4)_5%,black_14%,black_84%,rgba(0,0,0,0.4)_94%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,transparent_0%,rgba(0,0,0,0.4)_5%,black_14%,black_84%,rgba(0,0,0,0.4)_94%,transparent_100%)]"
        />
        {/* Vertical gradient for text legibility */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(180deg,rgba(5,6,8,0.94)_0%,rgba(5,6,8,0.6)_22%,rgba(5,6,8,0.18)_48%,rgba(5,6,8,0.1)_72%,rgba(5,6,8,0.45)_100%)]"
        />
        {/* Brand glow at the bottom */}
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(ellipse_70%_55%_at_50%_92%,rgba(161,216,95,0.34),transparent_60%)]"
        />
        {/* Atmospheric corner glows */}
        <div aria-hidden className="pointer-events-none absolute inset-0 z-0">
          <div className="absolute left-[-8%] top-[-5%] h-[360px] w-[360px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(108,207,81,0.12),transparent_70%)] blur-[100px]" />
          <div className="absolute right-[-8%] top-[-5%] h-[320px] w-[320px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.06),transparent_70%)] blur-[80px]" />
        </div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1180px] px-5 md:px-12 pt-[16vh] md:pt-[12vh] pb-[16vh] md:pb-[20vh] flex-1 flex flex-col justify-center">
          ...
          <h1 className="rise rise-2 display-lg text-center text-balance max-w-[18ch] md:max-w-[22ch] mx-auto text-paper">
          ...
          {/* Subhead */}
          <p className="rise rise-3 text-center max-w-[58ch] mx-auto mt-7 md:mt-9 text-[16px] md:text-[18px] leading-[1.55] text-paper/65">
          ...
          <div className="rise rise-3 mt-7 md:mt-9 flex flex-wrap items-center justify-center gap-x-5 gap-y-3 max-w-[760px] mx-auto">
            {services.map((s) => (
              <span
                key={s}
                className="inline-flex items-center gap-2 mono text-[10.5px] md:text-[11px] tracking-[0.2em] uppercase text-paper/75"
              >
                <span className="h-1 w-1 rounded-full bg-brand shadow-[0_0_6px_rgba(161,216,95,0.7)]" />
                {s}
              </span>
            ))}
          </div>
          ...
          <div className="rise rise-4 mt-9 md:mt-12 flex flex-col items-center gap-5">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <div className="flex -space-x-1.5">
                ...
                <Avatar letter="L" from="#b4e170" to="#4fb238" />
                ...
                <div className="flex items-center gap-[2px]">
                  {[0, 1, 2, 3, 4].map((i) => (
                    <svg
                      key={i}
                      viewBox="0 0 20 20"
                      className="h-[13px] w-[13px] fill-brand drop-shadow-[0_0_5px_rgba(161,216,95,0.45)]"
                    >
                      <path d="M10 1.6l2.5 5.9 6.4.5-4.9 4.2 1.5 6.2L10 15.3l-5.5 3.1 1.5-6.2L1 8l6.4-.5z" />
                    </svg>
                  ))}
                </div>
                <span className="text-[13.5px] font-semibold text-paper leading-none">
                  5,0/5
                </span>
              </div>
              <span className="h-5 w-px bg-white/15 hidden sm:inline-block" />
              <span className="mono text-[10.5px] tracking-[0.16em] uppercase text-paper/55 leading-none whitespace-nowrap hidden sm:inline">
                Qualiopi · 120 + formés
              </span>
            </div>
          </div>
...
function Avatar({ letter, from, to }) {
  return (
    <span
      className="relative inline-grid h-[22px] w-[22px] place-items-center rounded-full border border-white/20 font-semibold text-[10px] text-white/95 shadow-[0_1px_2px_rgba(0,0,0,0.3),0_0_0_2px_rgba(11,13,10,0.6)]"
      style={{
  ...
  return (
    <section className="bg-ink border-y border-white/5">
      <div className="mx-auto max-w-[1360px] px-5 md:px-12 py-7 flex flex-wrap items-center gap-x-8 gap-y-3">
        <span className="mono text-[10.5px] tracking-[0.18em] uppercase text-paper/45">
          Reconnaissances
        </span>
        <span className="hidden md:block flex-1 h-px bg-white/8" />
        <div className="flex flex-wrap items-center gap-x-7 gap-y-2">
          {items.map((l) => (
            <span
              key={l}
              className="font-medium text-[14.5px] tracking-[-0.005em] text-paper/85"
            >
              {l}
            </span>
          ))}
...
function Programmes() {
  return (
    <section
      id="programmes"
      className="relative bg-ink py-24 md:py-32 px-5 md:px-12"
    >
      <div aria-hidden className="absolute inset-0 grid-rule-dark opacity-30" />
      <div className="relative mx-auto max-w-[1360px]">
        <SectionHead
          ...
          title={
            <>
              ...
              <br />
              <em className="text-paper/55 font-light">Aucun superflu.</em>
            </>
          }
          ...
          {programmes.map((p) => (
            ...
            >
              <div className="flex items-center justify-between mb-7">
                <span className="mono text-[10.5px] tracking-[0.18em] uppercase text-paper/55 tab-nums">
                  {p.no} · {p.code}
                </span>
                {p.badge && (
                  <span className="mono text-[10px] tracking-[0.18em] uppercase bg-brand text-brand-ink px-2 py-1 rounded-full font-semibold">
                    {p.badge}
                  </span>
                )}
              </div>
              <h3 className="font-semibold text-[22px] md:text-[24px] leading-[1.15] tracking-[-0.02em] text-paper">
                {p.title}
              </h3>
              <p className="mt-3 text-[14.5px] leading-[1.6] text-paper/65 flex-1">
                {p.summary}
              </p>
              <div className="mt-7 pt-5 border-t border-white/8 flex items-center gap-3 mono text-[10.5px] tracking-[0.16em] uppercase text-paper/55">
                <span>{p.duration}</span>
                <span className="w-px h-3 bg-white/15" />
                <span>{p.format}</span>
                <span className="ml-auto text-paper/40 group-hover:text-brand transition-colors">
                  →
                </span>
              </div>
            </article>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <a
            href="#contact"
            className="mono text-[10.5px] tracking-[0.18em] uppercase text-paper/55 hover:text-brand transition-colors inline-flex items-center gap-2"
          >
            ↓ Catalogue PDF — 2,4 Mo
          </a>
          <span className="mono text-[10.5px] tracking-[0.16em] uppercase text-paper/45">
...
function Promesse() {
  return (
    <section className="relative dark-stage py-24 md:py-32 px-5 md:px-12 border-y border-white/5">
      <div className="relative mx-auto max-w-[1100px] text-center scroll-rise">
        <span className="eyebrow mb-7 block">02 / Promesse</span>
        <p className="display-md text-balance text-paper/95">
          On forme des professionnels qui doivent{" "}
          <em className="text-shimmer-brand">livrer</em>.
          <br />
          Pas des amateurs qui veulent comprendre.
        </p>
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-px bg-white/8 border border-white/8 max-w-3xl mx-auto">
          {[
            ["VI", "Programmes"],
            ["120+", "Apprenants"],
            ["5,0/5", "Satisfaction"],
            ...
            <div key={i} className="bg-ink py-6 px-4">
              <div className="font-semibold text-[26px] md:text-[34px] leading-none tracking-[-0.04em] tab-nums text-paper">
                {n}
              </div>
              <div className="mt-2 mono text-[10px] tracking-[0.16em] uppercase text-paper/50">
                {l}
              </div>
            </div>
          ))}
      ...
      <div className="relative mx-auto max-w-[1360px]">
        <SectionHead
          ...
          title={
            <>
              Le parcours,<br />
              <em className="text-paper/55 font-light">en six étapes.</em>
            </>
          }
        ...
        <ol className="border-t border-white/8">
          {methode.map((step) => (
            <li
              key={step.no}
              className="grid grid-cols-12 gap-4 md:gap-10 py-7 md:py-9 border-b border-white/8 group transition-colors hover:bg-white/[0.02] -mx-3 md:-mx-5 px-3 md:px-5"
            >
              <div className="col-span-2 md:col-span-1">
                <span className="mono text-[12px] tracking-[0.18em] tab-nums text-brand">
                  {step.no}
                </span>
              </div>
              <div className="col-span-10 md:col-span-7">
                <h3 className="font-semibold text-[22px] md:text-[28px] leading-[1.15] tracking-[-0.02em]">
                  {step.title}
                </h3>
                <p className="mt-3 text-[15px] md:text-[16px] leading-[1.6] text-paper/65 max-w-2xl">
                  {step.body}
                </p>
              </div>
              <div className="col-span-12 md:col-span-4 md:flex md:items-start md:justify-end">
                <span className="inline-flex items-center gap-2 mono text-[10.5px] tracking-[0.16em] uppercase text-paper/65 border border-white/10 bg-white/[0.02] px-3 py-1.5 rounded-full">
...
function Pourquoi() {
  return (
    <section className="relative bg-ink py-24 md:py-32 px-5 md:px-12 border-t border-white/5">
      <div aria-hidden className="absolute inset-0 grid-rule-dark opacity-25" />
      <div className="relative mx-auto max-w-[1360px]">
        <SectionHead
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/8 border border-white/8">
          {pourquoi.map((p) => (
            <article key={p.no} className="card-surface p-8 md:p-10 scroll-rise">
              ...
              <h3 className="font-semibold text-[24px] md:text-[30px] leading-[1.15] tracking-[-0.02em] max-w-[22ch]">
                {p.title}
              </h3>
              <p className="mt-5 text-[15px] md:text-[16px] leading-[1.65] text-paper/65 max-w-xl">
                {p.body}
              </p>
            </article>
          ))}
...
function Formateur() {
  return (
    <section
      id="formateur"
      className="relative bg-ink py-24 md:py-32 px-5 md:px-12 border-t border-white/5"
    >
      <div className="relative mx-auto max-w-[1360px]">
        <div className="grid grid-cols-12 gap-6 md:gap-12 items-start">
          <div className="col-span-12 md:col-span-4 lg:col-span-3 order-2 md:order-1">
            <figure className="aspect-[3/4] relative overflow-hidden border border-white/10 card-surface">
              <div className="absolute inset-0 grid place-items-center">
                <span className="font-semibold tracking-[-0.04em] leading-none text-paper" style={{ fontSize: "clamp(80px, 12vw, 156px)" }}>
                  DT
                </span>
              </div>
              ...
              <div aria-hidden className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(161,216,95,0.18),transparent_55%)]" />
            </figure>
            <p className="mt-3 mono text-[10.5px] tracking-[0.16em] uppercase text-paper/45">
          ...
          <div className="col-span-12 md:col-span-8 lg:col-span-8 lg:col-start-5 order-1 md:order-2">
            ...
            <div className="mt-8 space-y-5 text-[16px] md:text-[17px] leading-[1.7] text-paper/75 max-w-2xl">
              <p>
            ...
            <dl className="mt-10 grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-6 border-t border-white/10 pt-8 max-w-3xl">
...
function Cred({ k, v }) {
  return (
    <div>
      <dt className="mono text-[10.5px] tracking-[0.18em] uppercase text-paper/45 mb-2">
        {k}
      </dt>
      <dd className="text-[14.5px] leading-tight text-paper">{v}</dd>
    </div>
  );
}
    ...
    >
      <div className="relative mx-auto max-w-[1360px]">
        <SectionHead
          ...
          title={
            <>
              Ce qu'<em className="text-paper/55 font-light">elles et eux</em>
              <br />
              en disent.
            </>
          }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-white/8 border border-white/8">
          {temoignages.map((t, i) => (
            <figure key={i} className="card-surface p-8 md:p-10 scroll-rise flex flex-col">
                ...
                <div className="flex items-center gap-[2px]">
                  {[0, 1, 2, 3, 4].map((j) => (
                    <svg
                      key={j}
                      viewBox="0 0 20 20"
                      className="h-[14px] w-[14px] fill-brand drop-shadow-[0_0_4px_rgba(161,216,95,0.4)]"
                    >
                      <path d="M10 1.6l2.5 5.9 6.4.5-4.9 4.2 1.5 6.2L10 15.3l-5.5 3.1 1.5-6.2L1 8l6.4-.5z" />
                    </svg>
                  ))}
                </div>
                <span className="mono text-[10px] tracking-[0.18em] uppercase text-brand bg-brand/10 border border-brand/20 px-2 py-1 rounded-full">
                  {t.metric}
                </span>
              </div>
              <blockquote className="text-[18px] lg:text-[20px] leading-[1.4] tracking-[-0.005em] font-medium text-paper flex-1">
                « {t.quote} »
              </blockquote>
              <figcaption className="mt-8 pt-6 border-t border-white/10 flex items-end justify-between gap-4">
                <div>
                  ...
                  <div className="mono text-[10.5px] tracking-[0.14em] uppercase text-paper/55 mt-1">
                    {t.role}
                  </div>
                </div>
                <div className="mono text-[10.5px] tracking-[0.16em] uppercase text-paper/45">
                  {t.promo}
                </div>
              </figcaption>
            </figure>
...
function FinalCTA() {
  return (
    <section
      id="contact"
      className="relative dark-stage py-24 md:py-36 px-5 md:px-12 border-t border-white/5 overflow-hidden"
    >
      <div className="relative mx-auto max-w-[1100px] text-center">
        <span className="eyebrow mb-7 block">07 / Démarrer</span>
        <h2 className="display-lg text-balance max-w-[18ch] md:max-w-[22ch] mx-auto">
          Lancez votre diagnostic.{" "}
          <em className="text-shimmer-brand">Gratuit. 30 minutes.</em>
        </h2>
        <p className="mt-7 max-w-[58ch] mx-auto text-[16px] md:text-[18px] leading-[1.55] text-paper/65">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            <input
              ...
              className="md:col-span-8 bg-white/[0.04] border border-white/12 px-5 py-4 text-[15px] placeholder:text-paper/35 focus:outline-none focus:border-brand/60 focus:bg-white/[0.06] rounded-full transition-colors"
            />
            <button
              type="submit"
          ...
          <p className="mt-4 mono text-[10px] tracking-[0.18em] uppercase text-paper/45">
            Réponse sous 24 h ouvrées · RGPD · Sans engagement
          </p>
        </form>

        <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-px bg-white/8 border border-white/8 max-w-3xl mx-auto">
          {[
            ...
            <div key={k} className="bg-ink py-5 px-4">
              <div className="mono text-[10px] tracking-[0.18em] uppercase text-brand mb-1.5">
                {k}
              </div>
...
function Footer() {
  return (
    <footer className="relative bg-[#06070a] px-5 md:px-12 pt-16 pb-10 border-t border-white/5">
      <div className="mx-auto max-w-[1360px]">
        <div className="grid grid-cols-12 gap-8 md:gap-12">
          <div className="col-span-12 md:col-span-5">
            ...
            <p className="mt-5 text-[14px] text-paper/60 max-w-md leading-[1.7]">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-2">
              ...
              <span className="chip-dark">CPF · OPCO</span>
              <span className="chip-dark">SIREN 000 000 000</span>
            </div>
          </div>
        ...
        <div className="mt-14 flex flex-col md:flex-row justify-between gap-4 pt-6 border-t border-white/8 mono text-[10px] tracking-[0.16em] uppercase text-paper/45">
...
function FooterCol({ title, children }) {
  return (
    <div className="col-span-6 md:col-span-3 lg:col-span-2">
      <div className="mono text-[10.5px] tracking-[0.18em] uppercase text-paper/45 mb-4">
        {title}
      </div>
...
function FootLink({ children }) {
  return (
    <li>
      <a
        href="#"
        className="text-paper/70 hover:text-brand transition-colors"
      >
        {children}
      </a>
    </li>
...
function SectionHead({ eyebrow, title, subline }) {
  return (
    <div className="mb-12 md:mb-16 max-w-3xl scroll-rise">
      ...
      {subline && (
        <p className="mt-6 text-[16px] md:text-[18px] leading-[1.6] text-paper/65 max-w-2xl">
          {subline}
        </p>
      )}
    </div>
